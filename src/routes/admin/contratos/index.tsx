  ...
  return (
    <div className="p-6 md:p-12 space-y-12">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          <h1 className="text-3xl md:text-4xl font-bold tracking-tighter uppercase">Gestão de Contratos</h1>
              ...
              {filteredContracts.length > 0 ? (
                filteredContracts.map((contract) => (
                  <tr key={contract.id} className="hover:bg-white/5 transition group">
                    ...
                    <td className="p-4">
                      <span className={`text-[9px] font-bold uppercase tracking-widest px-3 py-1 border rounded-full inline-block whitespace-nowrap ${getStatusColor(contract.status)}`}>
                        {contract.status}
                      </span>
                    </td>
                ...
                <tr>
                  <td colSpan={7} className="p-24 text-center text-neutral-600 text-[10px] uppercase tracking-widest font-bold">
